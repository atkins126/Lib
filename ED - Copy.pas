...
type
  ...
  public
    ...
    function ECString(InputStr: string; Key1, Key2: Integer): string;
    function DCString(InputStr: string; Key1, Key2: Integer): string;
  private
    Key1, Key2: Integer;
    function ECStr(InputStr: string; Key: Integer): string;
    function DCStr(InputStr: string; Key: Integer): string;
...
function TED.ECString(InputStr: string; Key1, Key2: Word): string;
var
  S: string;
begin
  S := InputStr;
...
function TED.DCString(InputStr: string; Key1, Key2: Word): string;
var
  S: string;
begin
  S := InputStr;
...
function TED.ECStr(InputStr: string; Key1, Key2: Word): string;
var
  I: Integer;
  RStr: RawByteString;
...
function TED.DCStr(InputStr: string; Key: Word): string;
var
  I, tmpKey: Integer;
  RStr: RawByteString;
  RStrB: TBytes absolute RStr;
